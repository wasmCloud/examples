use petclinic_interface::{Date, ListVisitsRequest, RecordVisitRequest, Time, Visit, VisitList, Visits, VisitsReceiver};
...
impl Visits for VisitsActor {
    async fn list_visits(&self, _ctx: &Context, _arg: &ListVisitsRequest) -> RpcResult<VisitList> {
        Ok(
            vec![
                Visit{
                    date: Date { day: 11, month: 1, year: 2021 },
                ...
                Visit{
                    date: Date { day: 5, month: 5, year: 2021 },
