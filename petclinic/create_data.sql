...
insert into owners (id, address, city, email, firstname, lastname, telephone) values (8, '1234 Street Lane', 'Metropolis', 'patrick@email.com', 'Patrick', 'Gray', '123-123-1234');
-- Pets
...
insert into pets (id, pettype, name, bday, bmonth, byear, ownerid) values (11, 1, 'Cinza', 4, 18, 2019, 8);
